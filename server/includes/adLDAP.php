...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@cc-bassinpompey.local";
    ...
    * @var string
    */
	protected $baseDn = "DC=cc-bassinpompey,DC=local"; 
    ...
    * @var string
    */
	protected $adminUsername = 'lecturead';
    protected $adminPassword = 'LectureAD';
